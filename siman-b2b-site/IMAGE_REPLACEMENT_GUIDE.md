...
The homepage now supports direct real-image replacement through one config file.
...
```text
siman-b2b-site/src/siteAssets.ts
```
...
This means you can replace assets gradually without breaking the page.
